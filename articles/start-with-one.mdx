...
- Research notes get put into all different kinds of note files and lists, connected with links, etc.
...
*Most of the time I spent "organizing" didn't lead to any _pragmatic_ benefit.*
...
I faced this pattern so much in programming that I wrote a whole essay dedicated to it:
...
Start with one and stick with it for as long as it's convenient.
Often it would mean forever.

Keep it intentionally unstructured until is begs for structure for reasons that are rather pragmatic than intellectual.
...
Similarly, with time I learn which code/notes/tasks/etc are more likely to end up being important.
