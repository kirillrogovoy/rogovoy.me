...
Also, this post is my attempt to start sharing my honest experience, however good or bad, on the internet.
...
I want to stay vulnarable and honest.
...
I was very lucky to had been making more than spending for several years, and investing that in S&P500 during the bull phase of the market.
It resulted in enough savings to not think about money for at least a couple of years.

Looking back, I can't help but think that having too much runaway money can japordize your venture: too easy to get comfortable.

We didn't really know what we wanted to build, but we wanted to work together (having previously been collegues for 3.5+ years), and we knew, that the stars might not align again in the future.

With the sense of freedom, but also immense pressure that I couldn't explain, we started to brainstorm ideas.
...
Before 2020, I had been a web developer (with a mixture of leading teams, product management, analytics, and other things) for 7 years, and there had always been someone to tell me, at least on some level, what goal should be achieved.

Being able to do whatever I wanted did not taste as sweet as I pictured.
It felt like we could do any number of bad decisions, and there was nobody to tell us that.

However, that feeling was also one of the best exercises for taking responsibility for your life.
In the end, dealing with uncertainy, and taking personal responsibility for tough decisions is just another thing that you train by practicing, not learning from books.

I'm so tempted to say that, in hindsight, that experience has tought me to take ultimate responsibility for my life decisions, and made me an exceptionally self-directed person.
But it would be lie.
I'm 2.5 years in "doing whatever I want" and, at best, I've learned to freak out less.
...
Those few days of brainstorming and scoring different ideas using a dozen of factors had finally led us to the one pain we chose to persue.

We wanted all restaurants and cafes in the world to have modern digital menus with high-quality photos of each meal.
(Keep in mind that we are still several month away from the worldwide pandemic.)
...
In return, we could study the way they operated in general, along with their specific feeback about the product.
...
Undoubtebly, it has shaken almost every industry, with the hospitality businesses being especially vulnurable.
...
Problems would come and go in a matter of weeks, so it was really hard to capture a specific pain that we could solve.

At same time, we felt like we really worked hard and were productive.
...
Looking back, I think that the pandemic was the real reason why we had any traction.
...
In June we had none, so it felt like success!

Also, every indie hacker knows that the feeling of people actually handing you money for something you've done is ecstasic.
...
Some just thought that it's trendy to have a digital menu.
...
By this point, the cummulative opportunity cost is in $100,000s

Would you continue such a venture?

That's a though choice.
...
Starting from this point, there were only three kinds of tasks we could afford doing:
1. Fixing something that's broken.
2. Whatever brings us new customers.
3. Whatever helps us spent less time on support.
...
But it wasn't really our case.

We still were not sure if our customer was closer to a hotel restraurant, a downtown tourist venue, or a local coffee shop.

A random venue coming from Google Ads would just sign up and use the service, no questions, no assistance.
...
I had zero friends who were in restaurant business.
I, personally, wasn't interested in how restaurants were run and what a life of a staff member would be like.

All I cared was me, and people like me, who, among other things, visited restaurants.
But visitors weren't the ones who pay, nor could we find a reasonable way to change that.

Second, I started to get bored as a developer.
At the beginning, I'd learn a thing or two about running serverless functions, or working with AWS, or optimizing images.
But a QR menu service, with all it's specialized features, is just a CRUD app.
...
But for whatever reason, coding stopped being that place, and I didn't want to make things more complex just for sake of entertaining.

Another sign of me disliking the project was that I didn't want to talk about it with other people anymore.
...
We ended up growing our customer base from 50 to around 150 during that year, trippling our MRR.
...
## "Good morning, the war has started."

I don't remember much between Feb 24 and late March.
It has condenced into one hazy memory filled with sounds of sirens, midnight doom scrolling, and moving places.

All I can say is that I'm lucky to be writing this post on a fancy laptop while sipping fresh filter coffee in a beautiful city of Lviv, with all my body parts appropriately hanging from the right spots.

This post isn't about the war, and I'm certainly not the one to have sufferred the most, but you can imagine that an experience like that might make one reflect more on their life choices.

That reflection made it crystal clear that it was time to turn the page.

Luckily, about the time I ran out of my savings, which supported me for almost 2.5 years, our business started to generate just enough profit for me to not look for a job or a side gig.

We jointly decided to keep the business operating and heavely automated whatever still required our attention.
...
At best, I went from having no idea to having some idea about what I'm doing.
At the same time, it made me feel much more comfortable about being incompetent.

It completely disspelled the illusion that one must first get good at something and then do it.
...
I've learned that it's really important for me to be able to relate to my users, deeply.
...
When I was working for companies, I always felt the urge to improve the tools my team and I were using.
I don't know why.
Instead of applying my craft and solve problems with it, I wanted to improve the craft itself.
I wanted to think and talk about how we do more than about what we do.
...
Turns out, you can (and should) take that into account when choosing what to do.

With Foodba, I didn't. Therefore:
- I gained a lot of domain knowledge (food industry) I'm not going to use.
...
That sucks because, as I stop working on Foodba, it feels like not much changed since 2020.
It doesn't feel like I gained any inertia.
No unfair advantages.
No trump cards to play.

This time, I can do better.
At least, by entering the domain in which I see myself doing much more projects, and creating long-lasting value beyond any specific endeavor.
...
I want challenge, but not any challenge.

The ability of an entrepreneur to do whatever it takes to get the job done is often romantisized.
...
They are just not what fulfills me.

At the same time, there are a ton of scary challenges I'm exctied to take on:
- Writing
...
Avoiding things I don't like doesn't mean I'm going to stay away from opportunities that would work best if I did those things.
I'll be happy to delegate them, I just want to make sure it's not something that's critical to do at early stages.
...
It's extremelly competitive, but fairly meritocratic.

I believe it to still be the Wild West.

And so, I've decided to give it try.
I'll do my best to be as useful as possible to my own tribe, while explicitly doing things I enjoy the most.

That includes a number of (scary) things I've never done:
...
It might not seem like much, but for a person who isn't used to any public attention or criticism, it was nerve-wrecking.

Two months later, I released the first alpha version and recorded a 42-minute demo (I know!), available at impulse.dev.

Luckily, my partner from the previous venture has joined me, so that period didn't feel lonely nor like too much work.
...
Everyone who ran open-source projects without significant backing by Big Tech would tell you that it's very hard to make a living off open-source.
And they are right.
I'd like to discuss it in detail in my future posts, but it's definitely a long-term concern.
...
Subscribe to the newletter by using the form below, and follow me on Twitter.
